...
| theme-override-dark     | 3068 (3.7%)   | 2     | glyph AA on themed ground             | dark-theme override verified end to end: page ground replaced, unreadable text snapped to theme foreground, readable accents/decorations/block grounds preserved — both pens byte-agree on every policy decision                                                                                                                           |
