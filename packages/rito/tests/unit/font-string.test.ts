...
import { buildFontString } from '../../src/reference/ts-core/render/backends/canvas/text/font-string';
import type { FontShorthand } from '../../src/reference/ts-core/style/core/paint-types';
