...
export {
  ...
  extractAllFootnotes,
} from '../reference/ts-core/runtime/footnote-extractor';
...
export {
  ...
  parseNavDocument,
  parseNcx,
} from '../reference/ts-core/parser/index';
...
export {
  ...
  WORD_BREAK_VALUES,
  type WordBreak,
} from '../reference/ts-core/style/index';
...
export {
  ...
  createKnuthPlassLayouter,
  layoutBlocks,
  paginateBlocks,
} from '../reference/ts-core/layout/index';
export { DEFAULT_RUN_PAINT } from '../reference/ts-core/layout/text/run-paint-from-style';
...
export {
  ...
  type DrawCommand,
} from '../reference/ts-core/render/index';
export { paginateWithAssets, type Resources } from '../reference/reader/resources';

// ── Model ──────────────────────────────────────────────────────────
export { type LayoutElement, type Rect, type Spacing } from '../reference/ts-core/model/index';

// ── Diagnostics ────────────────────────────────────────────────────
export { createLogger, type Logger, type LogLevel } from '../reference/ts-core/utils/index';
...
} from '../reference/ts-core/interaction/index';
