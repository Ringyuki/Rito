...
/**
 * Project an existing source locator onto the current layout.
 *
 * Unlike createReadingPosition(), this preserves the incoming locator. Use it
 * for layout changes, restore, and bookmark jumps where pagination changes must
 * not rewrite the canonical source anchor.
 */
