...
export { buildManifestHrefMap, extractAllFootnotes } from '../ts-core/runtime/footnote-extractor';
...
export { DEFAULT_RUN_PAINT } from '../ts-core/layout/text/run-paint-from-style';
...
// ── Model ──────────────────────────────────────────────────────────
export { type LayoutElement, type Rect, type Spacing } from '../ts-core/model/index';

// ── Diagnostics ────────────────────────────────────────────────────
export { createLogger, type Logger, type LogLevel } from '../ts-core/utils/index';
...
} from '../ts-core/interaction/index';
